...
**TKTK: Describe mayoral-results here.**
...
```
cd mayoral-results
mkvirtualenv --no-site-packages mayoral-results
...
```
* * * * * ubuntu bash /home/ubuntu/apps/mayoral_results/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|mayoral-results|tweet|`location`||||
|mayoral-results|facebook|`location`||||
|mayoral-results|email|`location`||||
|mayoral-results|new-comment||||
|mayoral-results|open-share-discuss||||
|mayoral-results|close-share-discuss||||
|mayoral-results|summary-copied||||
|mayoral-results|featured-tweet-action|`action`||``tweet_url``|
|mayoral-results|featured-facebook-action|`action`||``post_url``|
